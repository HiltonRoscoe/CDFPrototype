...
> `Marks` should be used to capture marks that are *machine readable* only. Marks that convey voter intent but fall outside the target area should be handled as under [Adjudication](#Adjudication).
